...
import de.adesso.processors.ResponseProcessor;
import de.adesso.processors.ResponseProcessorManager;
...
public class ResponseProcessorTask extends ResponseProcessor {
    ...
    private void processCrawledQueryData() {
        if (!requestRepository.findByQueryStatus(RequestStatus.VALID_ANSWER_RECEIVED).isEmpty()) {
            ...
            responseProcessorManager.processResponse(processingQuery);
...
//        }
    ...
    private void processCreatedReposByMembers(OrganizationWrapper organization, ResponseWrapper responseWrapper, Query processingQuery) {
        ...
        this.doFinishingQueryProcedure(organization, processingQuery);
    }
    ...
    /**
     * Calculates the internal commits of the members in the own organization de.adesso.repositories. Generated as ChartJSData and saved in OrganizationDetail.
     *
     * @param organization
     */
    ...
    /**
     * Calculates the external pull de.adesso.requests of the members. Generated as ChartJSData and saved in OrganizationDetail.
     *
     * @param organization
     */
    ...
    /**
     * Finishing procedure of every post processing of the queries. Saves the changes and calculates the update cost.
     * Checks if there are any other de.adesso.requests of this type and if the complete organization is updated.
     * @param organization OrganizationWrapper which contains the information and is saved.
     * @param processingQuery Currently processed query.
     */
    private void doFinishingQueryProcedure(OrganizationWrapper organization, Query processingQuery) {
        organizationRepository.save(organization);
        RequestType requestType = processingQuery.getQueryRequestType();
