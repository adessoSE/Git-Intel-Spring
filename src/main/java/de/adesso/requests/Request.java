...
import de.adesso.config.Config;
import de.adesso.enums.RequestStatus;
import de.adesso.exceptions.InvalidGithubAPITokenException;
import de.adesso.exceptions.InvalidRequestContentException;
import de.adesso.objects.Query;
import de.adesso.objects.Response;
...
public abstract class Request {
    ...
    /**
     * Processing of the request for the de.adesso.repositories detail of the organization. Usage of the Response class for the de.adesso.repositories.
     * Throws NullPointerException if response data is null because of bad request.
     *
     * @param requestQuery Query used for the request
     * @param restTemplate RestTemplate created for the request
    ...
    private void processMemberRequest(Query requestQuery, RestTemplate restTemplate, HttpEntity entity) {
        ...
        if (response.getResponseMember().getDat