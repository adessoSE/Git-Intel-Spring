...
public class ResponseProcessorTask extends ResponseProcessor {
     ...
     *
     * @param requestType      Requires requestType to find pending de.adesso.gitstalker.core.requests of type
     * @param organizationName Requires organizationName to find pending de.adesso.gitstalker.core.requests for the associated organization
